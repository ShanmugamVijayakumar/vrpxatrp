...
async function handleTicketCreation(interaction, user, guild, type) {
    if (!guild) {
    ...
    const categoryId = type === "RP PACK" ? RP_CATEGORY_ID : OOC_CATEGORY_ID;
...
client.on(Events.InteractionCreate, async (interaction) => {
    ...
    try {
        ...
        if (["rp_ticket", "ooc_ticket"].includes(interaction.customId)) {
            ...
            const channel = await handleTicketCreation(interaction, interaction.user, interaction.guild, type);
